...
## Waarom aannemers nu al achterop raken

Veel Vlaamse KMO's werken vandaag nog met hetzelfde systeem als vijf jaar geleden:

- Klant belt of mailt
- Zaakvoerder noteert handmatig
- Opmeting wordt ingepland
- Offerte wordt opgebouwd in Word of Excel
- Offerte wordt verstuurd, soms na 3 tot 5 dagen
...
De meeste tijd gaat verloren bij het verzamelen van informatie. Klanten bellen, sturen losse mails, of laten een contactformulier achter zonder bruikbare gegevens.

Een gestructureerd intakeformulier verandert dat. De klant vult zelf in:

- Type woning (rijwoning, halfopen, vrijstaand)
- Bouwjaar
- Huidige verwarmingssysteem
- Gewenste werken
- Postcode (voor afstandsberekening)
- Beschikbaar budget (optioneel)

Die gegevens komen niet in een mailbox terecht. Ze gaan rechtstreeks in een database.

### Stap 2: Automatische kwalificatie
...
Aanvragen die niet passen, krijgen een automatisch antwoord met uitleg. Aanvragen die wel passen, gaan door naar stap 3.

### Stap 3: Offerte-generatie op basis van vaste parameters
...
3. BTW-tarieven toepast (6% of 21%, afhankelijk van bouwjaar)
...
Een offerte die verstuurd is, is nog geen opdracht. Veel aannemers sturen één offerte en wachten. Dat is een gemiste kans.

Een automatisch opvolgingssysteem stuurt:

- Na 48 uur: een vriendelijke herinnering
- Na 5 dagen: een vraag of er vragen zijn
- Na 10 dagen: een laatste contactmoment met eventuele aanbieding

Dat hoeft de zaakvoerder niet zelf te doen. Het systeem doet het.

---

## Mijn VerbouwPremie: de specifieke complexiteit

Het premiestelsel van 2026 brengt extra rekenwerk mee. De premie varieert op basis van:

- Het inkomen van de aanvrager (drie categorieën)
- Het type maatregel
...
| Element | Manueel | Geautomatiseerd |
|---|---|---|
| Tijd per offerte | 6 tot 10 uur | 45 tot 75 minuten |
| Doorlooptijd voor klant | 3 tot 7 dagen | Minder dan 1 uur |
| Foutmarge in premieberekening | Hoog | Laag (centrale parameters) |
| Capaciteit per maand | 15 tot 25 offertes | 60 tot 100+ offertes |
| Kost bij extra aanvragen | Extra personeel | Marginaal |
| Opvolging na offerte | Handmatig of vergeten | Automatisch en consistent |
...
**1. Alles tegelijk automatiseren**

Begin niet met een volledig nieuwe ERP, een nieuwe website en een nieuw CRM tegelijk. Dat duurt maanden en kost een fortuin. Kies één pijnpunt: de offertedoorlooptijd. Los dat eerst op.
...
Sommige aannemers laten de premieberekening weg "omdat het te ingewikkeld is". Grote fout. De klant wil weten wat hij netto betaalt. Wie dat niet toont, verliest aan de concurrent die het wel doet.
...
De aannemers die nu hun proces opzetten, zijn klaar als de aanvragen komen. Wie in januari 2026 begint te zoeken naar een oplossing, is al te laat.
...
## Drie sectoren die dit nu moeten lezen
